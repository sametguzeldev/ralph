...
Take a PRD (markdown file or text) and convert it to `scripts/ralph/prd.json` (relative to the project root). If `scripts/ralph/` does not exist, write `prd.json` to the project root instead.
